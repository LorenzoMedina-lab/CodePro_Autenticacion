...
* **Gestión de Sesiones Híbrida:** * *Sin estado (Stateless):* Emisión de JSON Web Tokens (JWT) para consumo desde aplicaciones móviles.
  * *Con estado (Stateful):* Inyección automática del JWT en Cookies HTTP-Only para clientes web.
...
DATABASE_URL=postgresql://passport_user:super_password_123@localhost:5432/passport_db
